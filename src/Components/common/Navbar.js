...
const Navbar = () => {
  ...
  let { dataa, user, handleLogout, fetchUser } = useContext(contxt)
  ...
  async function handleOut () {
    try {
      await handleLogout(token, navigate)
    } catch (error) {
      ...
      <nav className='navbar bg-dark'>
        <div className='container-fluid d-flex'>
          ...
          {localStorage.getItem('token') ? (
            <div class='dropdown'>
              <button
                className='bg-transparent border-0 rounded-pill dropdown'
                type='button'
              ...
              <ul
                class='dropdown-menu dropdown-menu-end px-2 bg-light'
              ...
              >
                ...
                <hr className='mt-0 mb-0 opacity-25' />
                <li>
          ...
          >
            ...
            {localStorage.getItem('token') ? (
              dataa.length > 0 ? (
                <div
                  className='notification d-flex justify-content-center align-items-center bg-white rounded-circle position-absolute'
                  style={{
                    height: '20px',
                    width: '20px',
                    position: 'absolute',
              ...
              {localStorage.getItem('token') ? (
                    ...
                    <div className='container-fluid'>
                      <div className='row bg-white px-3 py-4 rounded-4 mt-3'>
                        ...
                        <div className='row'>
                          ...
                          <div className='col d-flex justify-content-end fw-bold text-success'>
                            FREE!
                          </div>
                        </div>
                        <div className='row'>
                          <div className='col'>You got FREE SHIPPING!</div>
                        </div>
                ...
                <div>
                  <h3 className='text-center'>
                    <Link to={'/login'}>Login to check</Link>
                  </h3>
                </div>
              )}
            </div>
